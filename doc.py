...
# OpenAI API Key
client = OpenAI(api_key="xxxxxxxxxxxxxxxxxxxxxx")  # Replace with your OpenAI API key
...
def generate_document():
    ...
    try:
        ...
        if not company_details:
            messagebox.showerror("Error", "Failed to fetch company details. Please try again.")
            return

        print("Company Details:", company_details)  # Debugging statement
